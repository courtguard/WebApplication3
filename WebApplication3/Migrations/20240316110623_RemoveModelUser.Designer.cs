...
namespace WebApplication3.Migrations
{
    ...
    [Migration("20240316110623_RemoveModelUser")]
    partial class RemoveModelUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication3.Models.Vaccine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PetVaccine", b =>
                {
                    b.HasOne("WebApplication3.Models.Pet", null)
                        .WithMany()
                        .HasForeignKey("PetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication3.Models.Vaccine", null)
                        .WithMany()
